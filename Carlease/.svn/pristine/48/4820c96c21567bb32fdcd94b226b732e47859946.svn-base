package com.tools.widget.calendar;
...
import com.tools.widget.calendar.KCalendar.OnCalendarClickListener;
import com.tools.widget.calendar.KCalendar.OnCalendarDateChangedListener;

public class PopupWindows extends PopupWindow {
	private String TAG = PopupWindows.class.getSimpleName();
	...
	public PopupWindows(Context mContext, View parent,
			DateChangeCallBack callback, String lastTimeDate) {

		dateChangeCallBack = callback;
		View view = View.inflate(mContext, R.layout.tools_popupwindow_calendar,
				null);
		view.startAnimation(AnimationUtils.loadAnimation(mContext,
				R.anim.tools_fade_in));
		LinearLayout ll_popup = (LinearLayout) view.findViewById(R.id.ll_popup);
		ll_popup.startAnimation(AnimationUtils.loadAnimation(mContext,
				R.anim.tools_push_bottom_in_1));
		...
		if (!lastTimeDate.equals("")) {

			if (lastTimeDate.contains("-")) {
				date = lastTimeDate;
				String datesplit[] = lastTimeDate.split("[-]");
				int years = Integer.parseInt(datesplit[0]);
				int month = Integer.parseInt(datesplit[1]);
				popupwindow_calendar_month.setText(years + "年" + month + "月");
				calendar.showCalendar(years, month);
				calendar.setCalendarDayBgColor(lastTimeDate,
						R.drawable.tools_calendar_date_focused);
			}
		}
		...
		popupwindow_calendar_bt_enter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dateChangeCallBack.onChangeDate(date);
			}
		});
	}
