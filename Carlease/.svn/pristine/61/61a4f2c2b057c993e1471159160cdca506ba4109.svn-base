...
/**
 * 这是自定义的对话框，里面的方法和源码一样，但是改变了布局，还有里面的部分代码
 * UiUtils subclass of Dialog that can display one, two or three buttons. If you only want to
 ...
 */
public class AlertDialog extends android.app.AlertDialog implements DialogInterface {
    private HuzAlertController mAlert;

    protected AlertDialog(Context context) {
        this(context, R.style.tools_My_Theme_Dialog_Alert);
    }

    protected AlertDialog(Context context, int theme) {
        super(context, theme);
        mAlert = new HuzAlertController(context, this, getWindow());
    }

    protected AlertDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, R.style.tools_My_Theme_Dialog_Alert);
    ...
    public static class Builder extends android.app.AlertDialog.Builder {
        private final HuzAlertController.AlertParams P;
        ...
        public Builder(Context context) {
        	super(context);
            P = new HuzAlertController.AlertParams(context);
        }
