...
/**
 * 自定义对话框所需要的类，与自定义对话框com.tools.app.AlertDialog结合使用
 * @author mosq
 *2013-10-24下午1:24:02
 */
public class HuzAlertController{
	...
	public static int m_MyAlertContentViewId=R.layout.tools_huz_alert_dialog; //Ĭ�ϵĶԻ��򲼾�ID
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark = R.drawable.tools_huz_popup_full;
        int topDark = R.drawable.tools_huz_popup_top;
        int centerDark = R.drawable.tools_huz_popup_center;
        int bottomDark = R.drawable.tools_huz_popup_bottom;
        int fullBright = R.drawable.tools_huz_popup_full;
        int topBright = R.drawable.tools_huz_popup_top;
        int centerBright = R.drawable.tools_huz_popup_center;
        int bottomBright = R.drawable.tools_huz_popup_bottom;
        int bottomMedium = R.drawable.tools_huz_popup_bottom;
    ...
    public static class AlertParams {
        ...
        private void createListView(final HuzAlertController dialog) {
            final RecycleListView listView = (RecycleListView)
                    mInflater.inflate(R.layout.tools_huz_select_dialog, null);
            ListAdapter adapter;
            
            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.tools_huz_select_dialog_multichoice, android.R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(R.layout.tools_huz_select_dialog_multichoice,
                                    parent, false);
                        }
                ...
                int layout = mIsSingleChoice 
                        ? R.layout.tools_huz_select_dialog_singlechoice : R.layout.tools_huz_select_dialog_item;
                if (mCursor == null) {
