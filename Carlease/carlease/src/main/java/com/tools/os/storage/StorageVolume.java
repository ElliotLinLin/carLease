...
public class StorageVolume implements Parcelable {
	...
	public StorageVolume(File path, boolean removable,
			boolean emulated) {
		mPath = path;
		//		mDescriptionId = descriptionId; // 有一些手机获取不到
		//		mPrimary = primary; // 4.0版本没有此属性
		mRemovable = removable;
		mEmulated = emulated;
		//		mMtpReserveSpace = mtpReserveSpace; // 总是== 100 无用
		//		mAllowMassStorage = allowMassStorage;
		//		mMaxFileSize = maxFileSize; // 总是== 0 无用
		//mOwner = owner;
	}
