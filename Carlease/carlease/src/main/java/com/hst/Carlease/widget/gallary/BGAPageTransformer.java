...
import com.hst.Carlease.widget.gallary.transformer.DefaultPageTransformer;
...
public abstract class BGAPageTransformer implements ViewPager.PageTransformer {
    ...
    public static DefaultPageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
